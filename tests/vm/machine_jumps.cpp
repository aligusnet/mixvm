...
TEST_F(MachineJumpsTestSuite, jmp) {
  machine.jmp(make_instruction(cmd_jmp, 10));
...
TEST_F(MachineJumpsTestSuite, jov_jump_if_overflowed) {
  ...
  machine.jov(make_instruction(cmd_jmp, 11));
...
TEST_F(MachineJumpsTestSuite, jnov_jump_if_overflowed) {
  machine.overflow = true;
  machine.jnov(make_instruction(cmd_jmp, 12));
...
TEST_F(MachineJumpsTestSuite, jl_jump_if_less) {
  ...
  machine.jl(make_instruction(cmd_jmp, 13));
...
TEST_F(MachineJumpsTestSuite, je_jump_if_equal) {
  machine.compare_flag = cmp_equal;
  machine.je(make_instruction(cmd_jmp, 13));
...
TEST_F(MachineJumpsTestSuite, jg_jump_if_greater) {
  ...
  machine.jg(make_instruction(cmd_jmp, 14));
...
TEST_F(MachineJumpsTestSuite, jg_not_jump_if_not_greater) {
  machine.compare_flag = cmp_equal;
  machine.jg(make_instruction(cmd_jmp, 15));
...
TEST_F(MachineJumpsTestSuite, jge_jump_if_greater) {
  machine.compare_flag = cmp_greater;
  machine.jge(make_instruction(cmd_jmp, 16));
...
TEST_F(MachineJumpsTestSuite, jge_jump_if_equal) {
  machine.compare_flag = cmp_equal;
  machine.jge(make_instruction(cmd_jmp, 17));
...
TEST_F(MachineJumpsTestSuite, jge_not_jump_if_less) {
  machine.compare_flag = cmp_less;
  machine.jge(make_instruction(cmd_jmp, 18));
...
TEST_F(MachineJumpsTestSuite, jne_jump_if_less) {
  machine.compare_flag = cmp_less;
  machine.jne(make_instruction(cmd_jmp, 19));
...
TEST_F(MachineJumpsTestSuite, jle_not_jump_if_equal) {
  machine.compare_flag = cmp_equal;
  machine.jne(make_instruction(cmd_jmp, 20));
...
TEST_F(MachineJumpsTestSuite, jle_jump_if_greater) {
  machine.compare_flag = cmp_greater;
  machine.jne(make_instruction(cmd_jmp, 21));
...
TEST_F(MachineJumpsTestSuite, jle_jump_if_less) {
  machine.compare_flag = cmp_less;
  machine.jle(make_instruction(cmd_jmp, 22));
...
TEST_F(MachineJumpsTestSuite, jle_jump_if_equal) {
  machine.compare_flag = cmp_equal;
  machine.jle(make_instruction(cmd_jmp, 23));
...
TEST_F(MachineJumpsTestSuite, jle_not_jump_if_greater) {
  machine.compare_flag = cmp_greater;
  machine.jle(make_instruction(cmd_jmp, 24));
...
TEST_F(MachineJumpsTestSuite, jan_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.jan(make_instruction(cmd_ja, 25));
...
TEST_F(MachineJumpsTestSuite, jan_not_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.jan(make_instruction(cmd_ja, 26));
...
TEST_F(MachineJumpsTestSuite, jan_not_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.jan(make_instruction(cmd_ja, 27));
...
TEST_F(MachineJumpsTestSuite, jaz_not_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.jaz(make_instruction(cmd_ja, 28));
...
TEST_F(MachineJumpsTestSuite, jaz_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.jaz(make_instruction(cmd_ja, 29));
...
TEST_F(MachineJumpsTestSuite, jaz_not_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.jaz(make_instruction(cmd_ja, 30));
...
TEST_F(MachineJumpsTestSuite, jap_not_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.jap(make_instruction(cmd_ja, 31));
...
TEST_F(MachineJumpsTestSuite, jap_not_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.jap(make_instruction(cmd_ja, 32));
...
TEST_F(MachineJumpsTestSuite, jap_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.jap(make_instruction(cmd_ja, 33));
...
TEST_F(MachineJumpsTestSuite, jann_not_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.jann(make_instruction(cmd_ja, 34));
...
TEST_F(MachineJumpsTestSuite, jann_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.jann(make_instruction(cmd_ja, 35));
...
TEST_F(MachineJumpsTestSuite, jann_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.jann(make_instruction(cmd_ja, 36));
...
TEST_F(MachineJumpsTestSuite, janz_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.janz(make_instruction(cmd_ja, 37));
...
TEST_F(MachineJumpsTestSuite, janz_not_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.janz(make_instruction(cmd_ja, 38));
...
TEST_F(MachineJumpsTestSuite, janz_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.janz(make_instruction(cmd_ja, 39));
...
TEST_F(MachineJumpsTestSuite, janp_jump_if_ra_negative) {
  set_reg_a_value(-1);
  machine.janp(make_instruction(cmd_ja, 40));
...
TEST_F(MachineJumpsTestSuite, janp_jump_if_ra_zero) {
  set_reg_a_value(0);
  machine.janp(make_instruction(cmd_ja, 41));
...
TEST_F(MachineJumpsTestSuite, janp_not_jump_if_ra_positive) {
  set_reg_a_value(1);
  machine.janp(make_instruction(cmd_ja, 42));
...
TEST_F(MachineJumpsTestSuite, j1n_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1n(make_instruction(cmd_j1, 25));
...
TEST_F(MachineJumpsTestSuite, j1n_not_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1n(make_instruction(cmd_j1, 26));
...
TEST_F(MachineJumpsTestSuite, j1n_not_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1n(make_instruction(cmd_j1, 27));
...
TEST_F(MachineJumpsTestSuite, j1z_not_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1z(make_instruction(cmd_j1, 28));
...
TEST_F(MachineJumpsTestSuite, j1z_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1z(make_instruction(cmd_j1, 29));
...
TEST_F(MachineJumpsTestSuite, j1z_not_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1z(make_instruction(cmd_j1, 30));
...
TEST_F(MachineJumpsTestSuite, j1p_not_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1p(make_instruction(cmd_j1, 31));
...
TEST_F(MachineJumpsTestSuite, j1p_not_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1p(make_instruction(cmd_j1, 32));
...
TEST_F(MachineJumpsTestSuite, j1p_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1p(make_instruction(cmd_j1, 33));
...
TEST_F(MachineJumpsTestSuite, j1nn_not_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1nn(make_instruction(cmd_j1, 34));
...
TEST_F(MachineJumpsTestSuite, j1nn_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1nn(make_instruction(cmd_j1, 35));
...
TEST_F(MachineJumpsTestSuite, j1nn_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1nn(make_instruction(cmd_j1, 36));
...
TEST_F(MachineJumpsTestSuite, j1nz_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1nz(make_instruction(cmd_j1, 37));
...
TEST_F(MachineJumpsTestSuite, j1nz_not_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1nz(make_instruction(cmd_j1, 38));
...
TEST_F(MachineJumpsTestSuite, j1nz_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1nz(make_instruction(cmd_j1, 39));
...
TEST_F(MachineJumpsTestSuite, j1np_jump_if_ra_negative) {
  set_reg_i_value(1, -1);
  machine.j1np(make_instruction(cmd_j1, 40));
...
TEST_F(MachineJumpsTestSuite, j1np_jump_if_ra_zero) {
  set_reg_i_value(1, 0);
  machine.j1np(make_instruction(cmd_j1, 41));
...
TEST_F(MachineJumpsTestSuite, j1np_not_jump_if_ra_positive) {
  set_reg_i_value(1, 1);
  machine.j1np(make_instruction(cmd_j1, 42));
...
TEST_F(MachineJumpsTestSuite, j2n_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2n(make_instruction(cmd_j2, 25));
...
TEST_F(MachineJumpsTestSuite, j2n_not_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2n(make_instruction(cmd_j2, 26));
...
TEST_F(MachineJumpsTestSuite, j2n_not_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2n(make_instruction(cmd_j2, 27));
...
TEST_F(MachineJumpsTestSuite, j2z_not_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2z(make_instruction(cmd_j2, 28));
...
TEST_F(MachineJumpsTestSuite, j2z_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2z(make_instruction(cmd_j2, 29));
...
TEST_F(MachineJumpsTestSuite, j2z_not_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2z(make_instruction(cmd_j2, 30));
...
TEST_F(MachineJumpsTestSuite, j2p_not_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2p(make_instruction(cmd_j2, 31));
...
TEST_F(MachineJumpsTestSuite, j2p_not_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2p(make_instruction(cmd_j2, 32));
...
TEST_F(MachineJumpsTestSuite, j2p_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2p(make_instruction(cmd_j2, 33));
...
TEST_F(MachineJumpsTestSuite, j2nn_not_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2nn(make_instruction(cmd_j2, 34));
...
TEST_F(MachineJumpsTestSuite, j2nn_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2nn(make_instruction(cmd_j2, 35));
...
TEST_F(MachineJumpsTestSuite, j2nn_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2nn(make_instruction(cmd_j2, 36));
...
TEST_F(MachineJumpsTestSuite, j2nz_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2nz(make_instruction(cmd_j2, 37));
...
TEST_F(MachineJumpsTestSuite, j2nz_not_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2nz(make_instruction(cmd_j2, 38));
...
TEST_F(MachineJumpsTestSuite, j2nz_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2nz(make_instruction(cmd_j2, 39));
...
TEST_F(MachineJumpsTestSuite, j2np_jump_if_ra_negative) {
  set_reg_i_value(2, -1);
  machine.j2np(make_instruction(cmd_j2, 40));
...
TEST_F(MachineJumpsTestSuite, j2np_jump_if_ra_zero) {
  set_reg_i_value(2, 0);
  machine.j2np(make_instruction(cmd_j2, 41));
...
TEST_F(MachineJumpsTestSuite, j2np_not_jump_if_ra_positive) {
  set_reg_i_value(2, 1);
  machine.j2np(make_instruction(cmd_j2, 42));
...
TEST_F(MachineJumpsTestSuite, j3n_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3n(make_instruction(cmd_j3, 25));
...
TEST_F(MachineJumpsTestSuite, j3n_not_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3n(make_instruction(cmd_j3, 26));
...
TEST_F(MachineJumpsTestSuite, j3n_not_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3n(make_instruction(cmd_j3, 27));
...
TEST_F(MachineJumpsTestSuite, j3z_not_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3z(make_instruction(cmd_j3, 28));
...
TEST_F(MachineJumpsTestSuite, j3z_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3z(make_instruction(cmd_j3, 29));
...
TEST_F(MachineJumpsTestSuite, j3z_not_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3z(make_instruction(cmd_j3, 30));
...
TEST_F(MachineJumpsTestSuite, j3p_not_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3p(make_instruction(cmd_j3, 31));
...
TEST_F(MachineJumpsTestSuite, j3p_not_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3p(make_instruction(cmd_j3, 32));
...
TEST_F(MachineJumpsTestSuite, j3p_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3p(make_instruction(cmd_j3, 33));
...
TEST_F(MachineJumpsTestSuite, j3nn_not_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3nn(make_instruction(cmd_j3, 34));
...
TEST_F(MachineJumpsTestSuite, j3nn_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3nn(make_instruction(cmd_j3, 35));
...
TEST_F(MachineJumpsTestSuite, j3nn_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3nn(make_instruction(cmd_j3, 36));
...
TEST_F(MachineJumpsTestSuite, j3nz_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3nz(make_instruction(cmd_j3, 37));
...
TEST_F(MachineJumpsTestSuite, j3nz_not_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3nz(make_instruction(cmd_j3, 38));
...
TEST_F(MachineJumpsTestSuite, j3nz_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3nz(make_instruction(cmd_j3, 39));
...
TEST_F(MachineJumpsTestSuite, j3np_jump_if_ra_negative) {
  set_reg_i_value(3, -1);
  machine.j3np(make_instruction(cmd_j3, 40));
...
TEST_F(MachineJumpsTestSuite, j3np_jump_if_ra_zero) {
  set_reg_i_value(3, 0);
  machine.j3np(make_instruction(cmd_j3, 41));
...
TEST_F(MachineJumpsTestSuite, j3np_not_jump_if_ra_positive) {
  set_reg_i_value(3, 1);
  machine.j3np(make_instruction(cmd_j3, 42));
...
TEST_F(MachineJumpsTestSuite, j4n_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4n(make_instruction(cmd_j4, 25));
...
TEST_F(MachineJumpsTestSuite, j4n_not_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4n(make_instruction(cmd_j4, 26));
...
TEST_F(MachineJumpsTestSuite, j4n_not_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4n(make_instruction(cmd_j4, 27));
...
TEST_F(MachineJumpsTestSuite, j4z_not_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4z(make_instruction(cmd_j4, 28));
...
TEST_F(MachineJumpsTestSuite, j4z_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4z(make_instruction(cmd_j4, 29));
...
TEST_F(MachineJumpsTestSuite, j4z_not_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4z(make_instruction(cmd_j4, 30));
...
TEST_F(MachineJumpsTestSuite, j4p_not_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4p(make_instruction(cmd_j4, 31));
...
TEST_F(MachineJumpsTestSuite, j4p_not_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4p(make_instruction(cmd_j4, 32));
...
TEST_F(MachineJumpsTestSuite, j4p_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4p(make_instruction(cmd_j4, 33));
...
TEST_F(MachineJumpsTestSuite, j4nn_not_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4nn(make_instruction(cmd_j4, 34));
...
TEST_F(MachineJumpsTestSuite, j4nn_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4nn(make_instruction(cmd_j4, 35));
...
TEST_F(MachineJumpsTestSuite, j4nn_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4nn(make_instruction(cmd_j4, 36));
...
TEST_F(MachineJumpsTestSuite, j4nz_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4nz(make_instruction(cmd_j4, 37));
...
TEST_F(MachineJumpsTestSuite, j4nz_not_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4nz(make_instruction(cmd_j4, 38));
...
TEST_F(MachineJumpsTestSuite, j4nz_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4nz(make_instruction(cmd_j4, 39));
...
TEST_F(MachineJumpsTestSuite, j4np_jump_if_ra_negative) {
  set_reg_i_value(4, -1);
  machine.j4np(make_instruction(cmd_j4, 40));
...
TEST_F(MachineJumpsTestSuite, j4np_jump_if_ra_zero) {
  set_reg_i_value(4, 0);
  machine.j4np(make_instruction(cmd_j4, 41));
...
TEST_F(MachineJumpsTestSuite, j4np_not_jump_if_ra_positive) {
  set_reg_i_value(4, 1);
  machine.j4np(make_instruction(cmd_j4, 42));
...
TEST_F(MachineJumpsTestSuite, j5n_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5n(make_instruction(cmd_j5, 25));
...
TEST_F(MachineJumpsTestSuite, j5n_not_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5n(make_instruction(cmd_j5, 26));
...
TEST_F(MachineJumpsTestSuite, j5n_not_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5n(make_instruction(cmd_j5, 27));
...
TEST_F(MachineJumpsTestSuite, j5z_not_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5z(make_instruction(cmd_j5, 28));
...
TEST_F(MachineJumpsTestSuite, j5z_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5z(make_instruction(cmd_j5, 29));
...
TEST_F(MachineJumpsTestSuite, j5z_not_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5z(make_instruction(cmd_j5, 30));
...
TEST_F(MachineJumpsTestSuite, j5p_not_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5p(make_instruction(cmd_j5, 31));
...
TEST_F(MachineJumpsTestSuite, j5p_not_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5p(make_instruction(cmd_j5, 32));
...
TEST_F(MachineJumpsTestSuite, j5p_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5p(make_instruction(cmd_j5, 33));
...
TEST_F(MachineJumpsTestSuite, j5nn_not_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5nn(make_instruction(cmd_j5, 34));
...
TEST_F(MachineJumpsTestSuite, j5nn_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5nn(make_instruction(cmd_j5, 35));
...
TEST_F(MachineJumpsTestSuite, j5nn_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5nn(make_instruction(cmd_j5, 36));
...
TEST_F(MachineJumpsTestSuite, j5nz_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5nz(make_instruction(cmd_j5, 37));
...
TEST_F(MachineJumpsTestSuite, j5nz_not_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5nz(make_instruction(cmd_j5, 38));
...
TEST_F(MachineJumpsTestSuite, j5nz_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5nz(make_instruction(cmd_j5, 39));
...
TEST_F(MachineJumpsTestSuite, j5np_jump_if_ra_negative) {
  set_reg_i_value(5, -1);
  machine.j5np(make_instruction(cmd_j5, 40));
...
TEST_F(MachineJumpsTestSuite, j5np_jump_if_ra_zero) {
  set_reg_i_value(5, 0);
  machine.j5np(make_instruction(cmd_j5, 41));
...
TEST_F(MachineJumpsTestSuite, j5np_not_jump_if_ra_positive) {
  set_reg_i_value(5, 1);
  machine.j5np(make_instruction(cmd_j5, 42));
...
TEST_F(MachineJumpsTestSuite, j6n_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6n(make_instruction(cmd_j6, 25));
...
TEST_F(MachineJumpsTestSuite, j6n_not_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6n(make_instruction(cmd_j6, 26));
...
TEST_F(MachineJumpsTestSuite, j6n_not_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6n(make_instruction(cmd_j6, 27));
...
TEST_F(MachineJumpsTestSuite, j6z_not_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6z(make_instruction(cmd_j6, 28));
...
TEST_F(MachineJumpsTestSuite, j6z_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6z(make_instruction(cmd_j6, 29));
...
TEST_F(MachineJumpsTestSuite, j6z_not_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6z(make_instruction(cmd_j6, 30));
...
TEST_F(MachineJumpsTestSuite, j6p_not_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6p(make_instruction(cmd_j6, 31));
...
TEST_F(MachineJumpsTestSuite, j6p_not_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6p(make_instruction(cmd_j6, 32));
...
TEST_F(MachineJumpsTestSuite, j6p_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6p(make_instruction(cmd_j6, 33));
...
TEST_F(MachineJumpsTestSuite, j6nn_not_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6nn(make_instruction(cmd_j6, 34));
...
TEST_F(MachineJumpsTestSuite, j6nn_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6nn(make_instruction(cmd_j6, 35));
...
TEST_F(MachineJumpsTestSuite, j6nn_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6nn(make_instruction(cmd_j6, 36));
...
TEST_F(MachineJumpsTestSuite, j6nz_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6nz(make_instruction(cmd_j6, 37));
...
TEST_F(MachineJumpsTestSuite, j6nz_not_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6nz(make_instruction(cmd_j6, 38));
...
TEST_F(MachineJumpsTestSuite, j6nz_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6nz(make_instruction(cmd_j6, 39));
...
TEST_F(MachineJumpsTestSuite, j6np_jump_if_ra_negative) {
  set_reg_i_value(6, -1);
  machine.j6np(make_instruction(cmd_j6, 40));
...
TEST_F(MachineJumpsTestSuite, j6np_jump_if_ra_zero) {
  set_reg_i_value(6, 0);
  machine.j6np(make_instruction(cmd_j6, 41));
...
TEST_F(MachineJumpsTestSuite, j6np_not_jump_if_ra_positive) {
  set_reg_i_value(6, 1);
  machine.j6np(make_instruction(cmd_j6, 42));
...
TEST_F(MachineJumpsTestSuite, jxn_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxn(make_instruction(cmd_jx, 25));
...
TEST_F(MachineJumpsTestSuite, jxn_not_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxn(make_instruction(cmd_jx, 26));
...
TEST_F(MachineJumpsTestSuite, jxn_not_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxn(make_instruction(cmd_jx, 27));
...
TEST_F(MachineJumpsTestSuite, jxz_not_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxz(make_instruction(cmd_jx, 28));
...
TEST_F(MachineJumpsTestSuite, jxz_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxz(make_instruction(cmd_jx, 29));
...
TEST_F(MachineJumpsTestSuite, jxz_not_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxz(make_instruction(cmd_jx, 30));
...
TEST_F(MachineJumpsTestSuite, jxp_not_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxp(make_instruction(cmd_jx, 31));
...
TEST_F(MachineJumpsTestSuite, jxp_not_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxp(make_instruction(cmd_jx, 32));
...
TEST_F(MachineJumpsTestSuite, jxp_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxp(make_instruction(cmd_jx, 33));
...
TEST_F(MachineJumpsTestSuite, jxnn_not_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxnn(make_instruction(cmd_jx, 34));
...
TEST_F(MachineJumpsTestSuite, jxnn_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxnn(make_instruction(cmd_jx, 35));
...
TEST_F(MachineJumpsTestSuite, jxnn_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxnn(make_instruction(cmd_jx, 36));
...
TEST_F(MachineJumpsTestSuite, jxnz_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxnz(make_instruction(cmd_jx, 37));
...
TEST_F(MachineJumpsTestSuite, jxnz_not_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxnz(make_instruction(cmd_jx, 38));
...
TEST_F(MachineJumpsTestSuite, jxnz_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxnz(make_instruction(cmd_jx, 39));
...
TEST_F(MachineJumpsTestSuite, jxnp_jump_if_ra_negative) {
  set_reg_x_value(-1);
  machine.jxnp(make_instruction(cmd_jx, 40));
...
TEST_F(MachineJumpsTestSuite, jxnp_jump_if_ra_zero) {
  set_reg_x_value(0);
  machine.jxnp(make_instruction(cmd_jx, 41));
...
TEST_F(MachineJumpsTestSuite, jxnp_not_jump_if_ra_positive) {
  set_reg_x_value(1);
  machine.jxnp(make_instruction(cmd_jx, 42));
