...
protected:
  ...
  MachineKnuthStoresTestSuite() {
    address = 2000;
    machine.reg_a = make_word(POS_SIGN, 6, 7, 8, 9, 0);
    machine.reg_x = make_word(POS_SIGN, 16, 17, 18, 19, 20);
    machine.memory[address] = make_word(NEG_SIGN, 1, 2, 3, 4, 5);
  }
